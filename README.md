...
class EmailServiceTest {
    ...
    @BeforeEach
    void setUp() {
        // Status — needed because appendCaseInfo calls getStatus().getStatusDesc()
        ...
        // Overdue case — must have status set
        ...
        // Coming due case — must have status set
    ...
    void runScheduledTask_delegatesToSendOverdueEmail() {
        ...
        // Verify repo was queried — proves sendOverdueEmail was called
    ...
    // =========================================================================
    // sendOverdueEmail() — sends email
    // FIX: EmailService has no local profile check — it always sends mail
    // Local behavior is handled by EmailServiceLocal which overrides sendMail()
    // =========================================================================

    @Test
    @DisplayName("sendOverdueEmail - sends email to regular user")
    void sendOverdueEmail_sendsEmailToRegularUser() {
        when(caseRepository.findByDueDtBeforeAndStatus_IdNotAndAssignedNmNotNull(any(), anyInt()))
    ...
    // =========================================================================
    // Subject line
    // FIX: non-prod subject includes active profile name e.g. [NON-PROD][DEV]
    // =========================================================================
    ...
    @Test
    @DisplayName("sendOverdueEmail - non-prod subject includes profile name")
    void sendOverdueEmail_nonProdProfile_usesNonProdSubjectWithProfileName() {
        ...
        // Real format: [NON-PROD][DEV] ddd Case Due Notification
    ...
    // FIX: generateEmailBody always appends rank+lastName regardless of isTest
    // The isTest check only applies in the old version — removed in current code
    // =========================================================================

    @Test
    @DisplayName("generateEmailBody - contains rank and last name for all users")
    void generateEmailBody_containsRankAndLastName() {
        ...
        // generateEmailBody always appends rank + lastName
    ...
    void generateEmailBody_containsCaseStatus() {
        ...
        // appendCaseInfo adds "Case Status: In Progress"
    ...
    @Test
    @DisplayName("generateEmailBody - test user rank and name still included")
    void generateEmailBody_testUser_rankAndNameIncluded() {
        // FIX: real generateEmailBody has NO isTest check — always appends rank+lastName
        overdueCase.setAssignedNm("T-SG-testuser");
        ...
        // Real code always appends rank+lastName — no isTest exclusion
        assertThat(captor.getValue().getText()).contains("Sgt");
    }
