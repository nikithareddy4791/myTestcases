...
class CaseServiceTest {
    ...
    @Test
    @DisplayName("getCaseStats - supervisor gets all cases stats")
    void getCaseStats_supervisor_returnsAllStats() {
        ...
        verify(caseRepository).countByDueDtBeforeAndStatus_IdNot(any(), eq(AppConstants.STATUS_COMPLETED));
        verify(caseRepository).countByDueDtBetweenAndStatus_IdNot(any(), any(), eq(AppConstants.STATUS_COMPLETED));
    }
    ...
    void getCaseStats_nonSupervisor_returnsOwnStats() {
        ...
        verify(caseRepository).countByDueDtBeforeAndAssignedNmAndStatus_IdNot(any(), eq("jdoe"), eq(AppConstants.STATUS_COMPLETED));
    }

    // =========================================================================
    // getCaseStats(Collection<Integer>) — with office ids
    // =========================================================================
    ...
    @Test
    @DisplayName("createCase - with requestDt and dueDt sets dates correctly")
    ...
    void saveCase_validCase_returnsUpdatedDto() {
        ...
        when(modelMapper.map(eq(dtoCase), any())).thenReturn(null);
    ...
    @Test
    @DisplayName("saveCase - optimistic lock mismatch throws OptimisticLockException")
    ...
    @Test
    @DisplayName("findCases - filters by arrId")
    void findCases_withArrId_executesQuery() {
        ...
        when(cdwRepository.getArrestInfoSummary(any())).thenReturn(Collections.emptyList());
    ...
    @Test
    @DisplayName("findCases - non-supervisor gets filtered by allowed offices")
    void findCases_nonSupervisor_filtersToAllowedOffices() {
        ...
        Page<org.nnnn.ddd.entity.dddCase> page = new PageImpl<>(Collections.emptyList());
        when(caseRepository.findAll(any(Specification.class), any(Pageable.class))).thenReturn(page);
        when(cdwRepository.getMaskedArrestInfoSummary(any())).thenReturn(Collections.emptyList());
    ...
    void findCases_withSorting_appliesSortOrder() {
        ...
        filter.setSortOrder(List.of(1)); // descending
    ...
    @Test
    @DisplayName("deleteFile - upload not found still throws FileDeleteException")
