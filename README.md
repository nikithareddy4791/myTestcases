...
/**
 * Uses Spring's ReflectionTestUtils to inject CacheManager regardless
 * of field access modifier (private/package-private).
 * Uses real SimpleCacheManager — no Mockito stubbing needed.
 */
...
class CacheServiceTest {
    ...
    void setUp() {
        ...
        // Wire all caches into SimpleCacheManager
        ...
        // Create service and inject CacheManager using ReflectionTestUtils
        // This works regardless of whether the field is private or package-private
        cacheService = new CacheService();
        ReflectionTestUtils.setField(cacheService, "cacheManager", cacheManager);

        // Pre-populate all caches with dummy data
    ...
    @Test
    @DisplayName("clearUserCache - only clears 2 user caches")
    void clearUserCache_onlyClearsTwoUserCaches() {
        cacheService.clearUserCache();
